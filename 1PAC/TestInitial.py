...
import mlp_scalable_bmm as compress_model
...
flags.DEFINE_string('input_dir', '../data/enwik9', 'input data dir')
flags.DEFINE_string('prefix', '_enwik9', 'output dir')
...
def main(_):
    ...
    print(
        "FLAGS.seq_len change from {} to {} due to FLAGS.vocab_dim = {} and FLAGS.hidden_dim = {}.".format(old_seq_len,
                                                                                                           FLAGS.seq_len,
                                                                                                           FLAGS.vocab_dim,
                                                                                                           FLAGS.hidden_dim))

    # series = np.array(load_file_be16(FLAGS.input_dir))
