...
from patchCompress import PatchTST_backbone
import numpy as np
import torch
...
def encode(temp_dir, compressed_file, FLAGS, series, train_data, last_train_data):
  ...
  print("Time for GPU to GPU operations: ", time_gpu_to_gpu)
  print("Time for model training: ", time_training)
  print("Time for GPU to CPU operations: ", time_gpu_to_cpu)
